    ...
    return (
        <div className="bg-gray-700 bg-opacity-10 shadow-sm h-20 grid grid-cols-3 items-center text-gray-600">
            ...
            <div className="justify-self-end px-3 flex gap-3 items-center">
                <button className="border-2 rounded-lg border-gray-700 text-gray-800 px-3 py-1 h-fit">Login</button>
                <button className="border-2 rounded-lg border-gray-700 text-gray-800 px-3 py-1 h-fit">Signup</button>
            </div>
        </div>
    )
}